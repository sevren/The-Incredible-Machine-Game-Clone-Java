...
/**
  ...
  @author Group Four
  */
public class SimpleDynamicBox implements Widget
{
    /* flags */
    ...
    private final float weight = 50.0f;
     ...
     * Basic constructor
     */
    public SimpleDynamicBox()
    {
		box = new Body(new Box(width, height),weight);
    ...
    {
        return new String("SimpleDynamicBox");
    }
    ...
    {
        return new String("A simple non-static box.");
    }
