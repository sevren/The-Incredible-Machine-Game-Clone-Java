...
public class BowlingBall implements Widget
{
	...
	public BowlingBall()
	{
		...
		imgicon = new ImageIcon(getClass().getClassLoader().getResource("resources/img/bowlingball.gif"));
		initializeBall();
	...
	*/
	private void initializeBall()
	{
		try
		{
			imgshown = ImageIO.read(getClass().getClassLoader().getResource("resources/img/bowlingball.gif"));
		}
		catch(IOException e)
		{
