...
public class BasketBall implements Widget
{
	...
	public BasketBall()
	{
		...
		imgicon = new ImageIcon(getClass().getClassLoader().getResource("resources/img/basketball.gif"));
		initializeBall();
	...
	*/
	private void initializeBall()
	{
		try
		{
			imgshown = ImageIO.read(getClass().getClassLoader().getResource("resources/img/basketball.gif"));
		}
		catch(IOException e)
		{
