...
public class AudioPlayer
{
	...
	public AudioPlayer()
	{
		try
		{
		//InputStream mis= ClassLoader.getSystemResource("resources/sounds/music.wav");
		//InputStream gis= ClassLoader.getSystemResource("resources/sounds/good.wav");
		//InputStream bis= ClassLoader.getSystemResource("resources/sounds/bad.wav");
			
			music = AudioSystem.getClip();
			
			music.open(AudioSystem.getAudioInputStream(getClass().getClassLoader().getResource("resources/sounds/music.wav")));
			good = AudioSystem.getClip();
			good.open(AudioSystem.getAudioInputStream(getClass().getClassLoader().getResource("resources/sounds/good.wav")));
			
			bad = AudioSystem.getClip();
			
			bad.open(AudioSystem.getAudioInputStream(getClass().getClassLoader().getResource("resources/sounds/bad.wav")));
